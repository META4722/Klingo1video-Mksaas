...
export const SocialLoginButton = ({
  ...
  // Use relative path with locale prefix instead of full URL for proper redirect
  const defaultCallbackUrl = locale !== 'en' ? `/${locale}${DEFAULT_LOGIN_REDIRECT}` : DEFAULT_LOGIN_REDIRECT;
